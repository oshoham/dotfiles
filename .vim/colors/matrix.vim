...
<!-- saved from url=(0062)http://vimcolorschemetest.googlecode.com/svn/colors/matrix.vim -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1"></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;">" vim:set ts=8 sts=2 sw=2 tw=0:
"
